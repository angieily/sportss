...
st.caption(
    "v29 hardened shared build • selected games persist • page failures are isolated instead of crashing the whole app."
)
    ...
    if not game:
        ...
        if roster.empty:
            st.warning(
                ...
                "Use the manual player search below; public-source research can still run."
            )
        st.write(
